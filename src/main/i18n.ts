...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    imWeixinYdHint: '微信通过 yd_cowork 本地网关运行，Bot 将在本地网关启动后自动连接。',
    imWeixinCredentialMissing: '微信凭据未找到，请先扫码登录。',
    imWeixinCredentialMissingSuggestion: '请在 IM 设置中点击“扫码连接微信”完成登录后再试。',
    imWeixinQrReady: '二维码已生成，请使用微信扫码确认登录。',
    imWeixinSessionMissing: '当前没有有效的微信登录会话，请先重新获取二维码。',
    imWeixinQrStartFailed: '获取微信二维码失败: {error}',
    imWeixinQrExpiredMain: '二维码已过期，请重新获取。',
    imWeixinQrWaitTimeout: '等待扫码确认超时，请重新获取二维码后再试。',
    imWeixinQrPollFailed: '轮询扫码状态失败: {error}',
    imWeixinQrInvalidPayload: '微信登录返回数据不完整，请重新扫码登录。',
    imWeixinQrFailedMain: '微信登录失败，请重新扫码后重试。',
    imWeixinQrSuccessMain: '微信登录成功。',
    unknownError: '未知错误',
  ...
  en: {
    ...
    imWeixinYdHint: 'WeChat runs via the yd_cowork local gateway and connects automatically after startup.',
    imWeixinCredentialMissing: 'WeChat credential was not found. Please complete QR login first.',
    imWeixinCredentialMissingSuggestion: 'Open IM settings and use "Scan to Connect WeChat" before retrying.',
    imWeixinQrReady: 'QR code is ready. Please scan with WeChat to continue.',
    imWeixinSessionMissing: 'No active WeChat login session. Please request a new QR code.',
    imWeixinQrStartFailed: 'Failed to get WeChat QR code: {error}',
    imWeixinQrExpiredMain: 'QR code expired. Please request a new one.',
    imWeixinQrWaitTimeout: 'Timed out waiting for QR confirmation. Please retry with a new QR code.',
    imWeixinQrPollFailed: 'Failed to poll QR login status: {error}',
    imWeixinQrInvalidPayload: 'WeChat login response is incomplete. Please scan again.',
    imWeixinQrFailedMain: 'WeChat login failed. Please retry.',
    imWeixinQrSuccessMain: 'WeChat login succeeded.',
