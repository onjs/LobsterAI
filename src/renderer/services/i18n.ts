...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    authQuotaExhausted: '当前模型额度已用完。请在设置中切换模型，或配置你自己的 API Key 后继续使用。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    coworkRenameTaskTitle: '重命名任务',
    coworkRenameTaskPlaceholder: '请输入任务名称',
    moveToProject: '移至项目',
    ...
    coworkDeleteGroupConfirmMessage: '确定要删除“{name}”下的 {count} 条任务记录吗？此操作不可撤销。',
    searchChats: '搜索聊天',
    ...
    coworkAgentEngineOpenClawUnavailableHint: '当前构建配置已禁用 OpenClaw 引擎。',
    coworkAgentEngineClaudeLegacy: 'Cowork',
    coworkAgentEngineClaudeLegacyHint: '内置引擎，开箱即用，推荐作为日常任务主引擎。',
    coworkAgentEngineYdCoworkUnavailableHint: '当前构建配置已禁用 yd_cowork 引擎。',
    coworkScheduledTaskBackend: '定时任务后端',
    coworkScheduledTaskBackendAuto: '自动（跟随 Agent 引擎）',
    coworkScheduledTaskBackendAutoHint: 'OpenClaw 引擎时使用 OpenClaw，yd_cowork 引擎时使用 yd_cowork。',
    coworkScheduledTaskBackendYdCowork: 'yd_cowork',
    coworkScheduledTaskBackendYdCoworkHint: '使用本地 yd_cowork 定时任务后端（开发中）。',
    coworkScheduledTaskBackendYdCoworkUnavailableHint: '当前构建配置已禁用 yd_cowork 定时任务后端。',
    coworkScheduledTaskBackendOpenClaw: 'OpenClaw',
    coworkScheduledTaskBackendOpenClawHint: '使用 OpenClaw gateway 的 cron.* 能力。',
    coworkScheduledTaskBackendOpenClawUnavailableHint: '当前构建配置已禁用 OpenClaw 定时任务后端。',
    coworkScheduledTaskBackendResolved: '当前生效后端',
    coworkBuildProfileYdOnlyNotice: '当前构建模式为 yd-only，仅允许使用 yd_cowork 引擎与后端。',
    coworkBuildProfileOpenClawOnlyNotice: '当前构建模式为 openclaw-only，仅允许使用 OpenClaw 引擎与后端。',
    ...
    agentModel: '模型',
    agentModelInheritGlobal: '使用全局默认模型',
    agentIdentity: '身份',
    ...
    scheduledTasksTabTasks: '定时任务',
    scheduledTasksTabHistory: '执行记录',
    ...
    scheduledTasksHistoryFilterDay: '按天',
    scheduledTasksHistoryFilterWeek: '按周',
    scheduledTasksHistoryFilterMonth: '按月',
    scheduledTasksHistoryFilterAllTasks: '全部任务',
    scheduledTasksHistoryFilterAllStatus: '全部状态',
    scheduledTasksHistoryNoFilteredResults: '没有符合筛选条件的执行记录',
    ...
    scheduledTasksFormMonthlyDayLabel: '每月第 {day} 天',
    scheduledTasksFormPlanTime: '计划时间',
    scheduledTasksFormHourlyAtMinute: '每小时的第',
    scheduledTasksFormCreateTitle: '新建定时任务',
    scheduledTasksFormCreateSubtitle: '按计划自动执行任务，也可随时手动触发。在任意对话中描述你想定时做的事，即可快速创建。',
    scheduledTasksFormUpdateTitle: '编辑定时任务',
    scheduledTasksFormUpdateSubtitle: '调整任务名称、执行时间和执行内容，保存后立即生效。',
    scheduledTasksFormTaskName: '任务名称',
    scheduledTasksFormTaskNamePlaceholder: '描述你的任务',
    scheduledTasksFormActionPromptLabel: '让 Agent 帮你做什么...',
    scheduledTasksFormActionPromptPlaceholder: '输入任务执行指令...',
    ...
    scheduledTasksFormNotifyOptional: 'IM 通知（可选）',
    scheduledTasksFormNotifyEnabled: '已开启',
    scheduledTasksFormNotifyDisabled: '已关闭',
    scheduledTasksFormNotifyNotRequired: '不选择 IM 通知也可以创建并运行定时任务。',
  ...
  en: {
    ...
    authQuotaExhausted: 'The current model quota is exhausted. Switch models or configure your own API key in Settings.',
    ...
    coworkRenameTaskTitle: 'Rename Task',
    coworkRenameTaskPlaceholder: 'Enter task name',
    ...
    coworkDeleteGroupConfirmMessage: 'Are you sure you want to delete {count} task records under "{name}"? This action cannot be undone.',
    ...
    coworkImTasks: 'Channel Tasks',
    coworkMyPrefix: 'My ',
    coworkManualTasks: 'Session Tasks',
    ...
    coworkAgentEngineOpenClawUnavailableHint: 'OpenClaw engine is disabled by the active build profile.',
    coworkAgentEngineClaudeLegacy: 'Cowork',
    coworkAgentEngineClaudeLegacyHint: 'Built-in engine, ready out of the box, recommended for daily tasks.',
    coworkAgentEngineYdCoworkUnavailableHint: 'yd_cowork engine is disabled by the active build profile.',
    coworkScheduledTaskBackend: 'Scheduled Task Backend',
    coworkScheduledTaskBackendAuto: 'Auto (follow Agent Engine)',
    coworkScheduledTaskBackendAutoHint: 'Use OpenClaw when the agent engine is OpenClaw, otherwise use yd_cowork.',
    coworkScheduledTaskBackendYdCowork: 'yd_cowork',
    coworkScheduledTaskBackendYdCoworkHint: 'Use the local yd_cowork scheduled-task backend (in progress).',
    coworkScheduledTaskBackendYdCoworkUnavailableHint: 'yd_cowork scheduled-task backend is disabled by the active build profile.',
    coworkScheduledTaskBackendOpenClaw: 'OpenClaw',
    coworkScheduledTaskBackendOpenClawHint: 'Use OpenClaw gateway cron.* APIs.',
    coworkScheduledTaskBackendOpenClawUnavailableHint: 'OpenClaw scheduled-task backend is disabled by the active build profile.',
    coworkScheduledTaskBackendResolved: 'Effective backend',
    coworkBuildProfileYdOnlyNotice: 'Current build profile is yd-only. Only yd_cowork engine/backend are available.',
    coworkBuildProfileOpenClawOnlyNotice: 'Current build profile is openclaw-only. Only OpenClaw engine/backend are available.',
    ...
    agentModel: 'Model',
    agentModelInheritGlobal: 'Use global default model',
    ...
    scheduledTasksTabTasks: 'Scheduled Tasks',
    scheduledTasksTabHistory: 'Execution Records',
    ...
    scheduledTasksHistoryFilterDay: 'By Day',
    scheduledTasksHistoryFilterWeek: 'By Week',
    scheduledTasksHistoryFilterMonth: 'By Month',
    scheduledTasksHistoryFilterAllTasks: 'All Tasks',
    scheduledTasksHistoryFilterAllStatus: 'All Statuses',
    scheduledTasksHistoryNoFilteredResults: 'No run records match the current filters',
    ...
    scheduledTasksFormMonthlyDayLabel: 'Day {day} of each month',
    scheduledTasksFormPlanTime: 'Schedule',
    scheduledTasksFormHourlyAtMinute: 'At minute',
    scheduledTasksFormCreateTitle: 'Create Scheduled Task',
    scheduledTasksFormCreateSubtitle: 'Run tasks automatically on a plan, or trigger them manually anytime.',
    scheduledTasksFormUpdateTitle: 'Edit Scheduled Task',
    scheduledTasksFormUpdateSubtitle: 'Update the task name, schedule, and execution prompt.',
    scheduledTasksFormTaskName: 'Task Name',
    scheduledTasksFormTaskNamePlaceholder: 'Describe your task',
    scheduledTasksFormActionPromptLabel: 'What should the Agent do for you...',
    scheduledTasksFormActionPromptPlaceholder: 'Enter task instructions...',
    ...
    scheduledTasksPrompt: 'Task Content',
    ...
    scheduledTasksFormNotifyOptional: 'IM Notification (Optional)',
    scheduledTasksFormNotifyEnabled: 'On',
    scheduledTasksFormNotifyDisabled: 'Off',
    scheduledTasksFormNotifyNotRequired: 'You can create and run scheduled tasks without IM notification.',
